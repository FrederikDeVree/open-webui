...
def get_citation_source_from_tool_result(
    ...
    Returns a list of sources (usually one, but search_knowledge_files/query_chat_files may return multiple).
    """
    _EXPECTS_LIST = {'search_web', 'search_knowledge_files', 'query_chat_files'}
    ...
    try:
        ...
        elif tool_name in ('search_knowledge_files', 'query_chat_files'):
            chunks = tool_result
